...
<div class="container mt-5 table table-warning table-striped" >
    <div class="row justify-content-center">
        <div class="col-4">
            <div class="card">
                <div class="card-header  ">
                ☆☆--Promocion por Festividades --☆☆: <br><?php echo $cliente->nombres.' '.$cliente->apellidos.' '.$cliente->DNI; ?>
                </div>
                <form class="p-4" method="POST" action="registrarPromocion.php">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Plazo de oferta: </label>
